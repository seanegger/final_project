...
class CaptureAgent(Agent):
    ...
    def __init__(self, index, time_for_computing=.1):
        ...
        self.time_for_computing = an amount of time to give each turn for computing maze distances
    ...
    def register_team(self, agents_on_team):
        """
        Fills the self.agents_on_team field with a list of the
    ...
    def display_distributions_over_positions(self, distributions):
        ...
        if self.display != None and 'update_distributions' in dir(self.display):
